      ...
      <div className="p-6">
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10 text-center max-w-md mx-auto">
          <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4"
            style={{ background: "var(--violet-bg, #EDE9FE)", color: "#7C3AED" }}>
            <Lock size={24} />
          </div>
          <h3 className="font-semibold text-base mb-2">BIM / Model Links</h3>
          <p className="text-sm mb-1 font-medium" style={{ color: "#7C3AED" }}>Available in MeasureDeck V1.5</p>
          <p className="text-sm mb-5" style={{ color: "var(--text-muted)" }}>
            Link drawings to BIM model elements, view the federated model in 3D, and see which drawing sheets are derived from BIM. Identify clashes and track coordination status across disciplines.
          </p>
          <button className="btn btn-primary btn-sm">Upgrade to V1.5</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button className="btn btn-secondary btn-sm"><Link2 size={14} /> Link BIM Element</button>
      </div>
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10 text-center">
        <Cpu size={28} className="mx-auto mb-3" style={{ color: "var(--text-muted)" }} />
        <p className="font-medium text-sm">No BIM elements linked</p>
        <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>Link this drawing to BIM model elements to enable coordination tracking.</p>
      </div>
    </div>
  );
}
