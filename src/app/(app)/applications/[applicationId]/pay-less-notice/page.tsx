      ...
      if (members) {
        for (const m of members) {
          await createNotification(supabase, {
            ...
            action_url: `/applications/${applicationId}/pay-less-notice`,
            urgency: "high",
          });
        }
      }
              ...
              <div className="p-5 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    {
                      label: "Notified Sum",
                      value: formatCurrencyFull(pln.notified_sum),
                    },
                    {
                      label: "Amount Withheld",
                      value: `(${formatCurrencyFull(pln.withheld_amount)})`,
                    },
                    {
                      label: "Amount to Pay",
                      value: formatCurrencyFull(pln.amount_to_pay),
                      bold: true,
                    },
