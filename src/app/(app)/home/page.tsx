  ...
  return (
    <div className="flex flex-col min-h-full">
      ...
      <div className="page-content flex-1">
        {tab === "overview"             && <OverviewTab loading={loading} kpi={kpi} router={router} />}
        ...
        {tab === "recent-activity"      && <RecentActivityTab />}
...
function OverviewTab({ loading, kpi, router }: {
  loading: boolean;
  kpi: typeof SEED_KPI;
...
function RecentActivityTab() {
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <p className="text-sm" style={{ color: "var(--text-muted)" }}>
          Last {SEED_ACTIVITY_FEED.length} events across all projects.
        </p>
