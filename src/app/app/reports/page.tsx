...
type ReportCategory = "all" | "project" | "board-pack" | "cvr" | "custom";
...
const TYPE_META: Record<ReportType, { icon: React.ReactNode; chip: string }> = {
  ...
  "Board Pack":              { icon: <Presentation size={14} />, chip: "chip-primary" },
...
export default function ReportsPage() {
  ...
  const analyticsEnabled = getFlag("cross_project_analytics");
  ...
  const filtered = reports.filter(r => {
    ...
    const matchCategory = categoryFilter === "all"
      || (categoryFilter === "board-pack" && r.type === "Board Pack")
      || (categoryFilter === "cvr" && r.type === "CVR Report")
      || (categoryFilter === "custom" && r.type === "Custom")
      || (categoryFilter === "project" && !["Board Pack", "CVR Report", "Custom"].includes(r.type));
  ...
  const allTypes: ReportType[] = [
    ...
    "Final Account Summary", "Evidence Pack", "Commercial Dashboard",
    "Project Status Report", "Board Pack", "Custom",
  ];

  const CATEGORIES: { value: ReportCategory; label: string }[] = [
    { value: "all", label: "All Reports" },
    { value: "project", label: "Project Reports" },
    { value: "board-pack", label: "Board Packs" },
    { value: "cvr", label: "CVR Reports" },
      ...
      <div className="page-header">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {analyticsEnabled && (
            ...
            >
              <Presentation size={14} />Generate Board Pack
            </button>
          )}
          <button className="btn btn-primary btn-sm" onClick={() => router.push("/reports/new")}>
...
function ReportBuilder() {
  ...
  const sections: Record<ReportType, string[]> = {
    ...
    "Board Pack":              ["Cover Page", "Executive Summary", "Project Summaries", "CE Register", "Cash Position", "Risk Register"],
